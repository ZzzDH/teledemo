...
# url = 'https://www.zhihu.com/api/v4/questions/527445211/similar-questions?include=data%5B*%5D.answer_count%2Cauthor
# %2Cfollower_count&limit=5'
# url = "https://www.zhihu.com/api/v4/questions//527445211/answers?include=content"
for i in range(0,500,5):
    url = 'https://www.zhihu.com/api/v4/questions//527445211/answers?include=data%5B%2A%5D.is_normal' \
    ...
    '.settings.table_of_content.enabled&limit=5&offset='+ str(i)+'&platform=desktop&sort_by=default'
#url = 'https://www.zhihu.com/api/v4/question//527445211/answer2587513982'
    ...
    for i in jtext['data']:
        if i['id']==2587513982 :
            context = pq(i['content']).text()
            print(context)

    # if jtext['data']['id'] == "2587513982":
    #     print(jtext['data'])
    #     break
# i = 0
# print(jtext)
